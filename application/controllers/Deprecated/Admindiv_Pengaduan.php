...
class Admindiv_Pengaduan extends CI_Controller
{
    ...
    public function index()
    {
        ...
        $data['semua_pengaduan'] = $this->M_lapor->semua_pengaduandiv($id);
        $this->load->view('admindiv_data_pengaduan', $data);
    }
    ...
    public function update()
    {
        ...
        if ($cek > 0) {
            echo ("<script LANGUAGE='JavaScript'>window.alert('Update Berhasil');window.location.href='detail_lapor_admin?id=" . $id . "';</script>");
        } else {
            echo ("<script LANGUAGE='JavaScript'>window.alert('Update Gagal');window.location.href='detail_lapor_admin?id=" . $id . "';</script>");
        }
    }
