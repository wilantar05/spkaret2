        ...
        <div id="wrapper">
            ...
            <div class="content">
                ...
                <section class="parallax-section single-par" data-scrollax-parent="true">
                    <div class="bg par-elem " data-bg="<?php echo site_url(); ?>assets/umum/images/bg/bg.jpg" data-scrollax="properties: { translateY: '30%' }"></div>
                    <div class="overlay op7"></div>
                    <div class="container">
                        <div class="section-title center-align big-title">
                            <h2><span>Kebijakan Privasi (Privacy Policy)</span></h2>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-12">
                                    <div class="ab_text">
                                        ...
                                        <br>
                                        <h1 align="left">Privacy Policy for PANDUMAS</h1>
