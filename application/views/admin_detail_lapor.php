                    ...
                    <form action="<?php echo site_url(); ?>update_pengaduan?id=<?php echo $detail->id_pengaduan; ?>&&id2=<?php echo $detail->id_pelapor; ?>" method="post" enctype="multipart/form-data">
                      ...
                      <div class="row">
                        <div class="col-sm-6">
                          ...
                          <input required type="text" name="nama_lengkap" value="<?php echo $detail->nama; ?>">
                        </div>
                        <div class="col-sm-6">
                          <label style="padding: 10px;">Nomor HP <i class="far fa-phone" style="top: 50px;"></i></label>
                          <input required type="text" name="no_telepon" value="<?php echo $detail->no_telepon; ?>">
                        </div>
                        <div class="col-sm-6">
                          <label style="padding: 10px;">Alamat<i class="far fa-envelope" style="top: 50px;"></i> </label>
                          <input required type="text" name="alamat" value="<?php echo $detail->alamat; ?>">
                        </div>
                        <div class="col-sm-6">
                          <label style="padding: 10px;">Tanggal<i class="far fa-user" style="top: 50px;"></i> </label>
                          <input required type="date" name="tanggal_pengaduan" value='<?php echo $detail->tanggal_pengaduan; ?>'>
                        </div>
                        <div class="col-sm-6">
                      ...
                      <textarea cols="40" rows="3" name="tindak_lanjut" placeholder="tindak_lanjut" style="margin-bottom:20px;"><?php echo $detail->tindak_lanjut; ?></textarea>
