                ...
                <div class="custom-form" style="padding: 20px;">
                  <form action="<?php echo site_url(); ?>pengaduan_admin" method="post" enctype="multipart/form-data">
                    <div class="row">
                      ...
                      <div class="col-sm-6">
                        <label style="padding: 10px;">Tanggal Lahir<i class="far fa-envelope" style="top: 50px;"></i> </label>
                        <input required type="date" name="tgl_lahir" value="">
                      </div>
                      <div class="col-sm-6">
                        <label style="padding: 10px;">Tanggal Laporan<i class="far fa-user" style="top: 50px;"></i> </label>
                        <input required type="date" name="tanggal_pengaduan" placeholder="<?php echo date('d-m-Y'); ?>" value="<?php echo date('d-m-Y'); ?>">
