...
<header class="main-header">
    <!-- logo-->
    <a href="<?php echo site_url(); ?>" class="show-reg-form modal-open avatar-img logo-holder" style="float: left;height: 80%;position: relative;top: 10px;"><img src="<?php echo site_url(); ?>assets/umum/images/logo4.png" alt=""></a>
    <!-- logo end-->
