                                        ...
                                        <tbody>
                                            ...
                                            ?>
                                                <tr>
                                                    ...
                                                    <td><a href="<?php echo site_url(); ?>artikel?id=<?php echo $informasi->id_informasi; ?>"><button type="button" class="btn btn-primary">Detail</button></a>
                                                        <a href="<?php echo site_url(); ?>edit_info?id=<?php echo $informasi->id_informasi; ?>"><button type="button" class="btn btn-warning">Edit</button></a>
                                                        <a href="<?php echo site_url(); ?>delete_info?id=<?php echo $informasi->id_informasi; ?>"><button type="button" class="btn btn-danger">Hapus</button></a>
                                                    </td>
                                                </tr>
                                            <?php } ?>
                                        </tbody>
