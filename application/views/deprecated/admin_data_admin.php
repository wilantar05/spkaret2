                                        ...
                                        <tbody>
                                            ...
                                            ?>
                                                <tr>
                                                    ...
                                                    <td><a href="<?php echo site_url(); ?>detail_admin?id=<?php echo $admin->id; ?>"><button type="button" class="btn btn-warning">Edit</button></a><a href="<?php echo site_url(); ?>hapus_admin?id=<?php echo $admin->id; ?>"><button type="button" class="btn btn-danger">Hapus</button></a></td>
                                                </tr>
                                            <?php } ?>
                                        </tbody>
                                    </table>
