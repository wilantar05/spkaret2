                            ...
                            ?>
                                <div class="list-single-main-item fl-wrap block_box " style="padding: 20px;">
                                    <div class="custom-form" style="padding: 20px;">
                                        <form action="<?php echo site_url(); ?>p_tindak_lanjutdiv?id=<?php echo $detail->id_pengaduan; ?>&&id2=<?php echo $detail->id_pelapor; ?>" method="post" enctype="multipart/form-data">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-sm-6">
                                                    ...
                                                    <div class="listsearch-input-item">
                                                        <select disabled name="bidang" class="chosen-select no-search-select" required>
                                            ...
                                            <br>
                                            <!-- <textarea cols="40" rows="3"  name="tindak_lanjut" placeholder="Tindak Lanjut" style="margin-bottom:20px;"><?php //echo $detail->tindak_lanjut; 
                                                                                                                                                            ?></textarea> -->
