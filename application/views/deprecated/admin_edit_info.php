                        ...
                        <div class="col-md-9">
                            ...
                            <div class="list-single-main-item fl-wrap block_box " style="padding: 20px;">
                                <div class="custom-form" style="padding: 20px;">
                                    <form action="<?php echo site_url(); ?>update_info?id=<?php echo $informasi->id_informasi; ?>" method="post" enctype="multipart/form-data">

                                        <div class="row">
                                            <div class="col-sm-6">
                                                <label style="padding: 10px;">Judul<i class="fal fa-user" style="top: 50px;"></i></label>
                                                <input required type="text" name="judul" placeholder="Judul" value="<?php echo $informasi->judul; ?>">
                                            </div>

                                            <div class="col-sm-12">
                                                <label style="padding: 10px;">URL Gambar Thumbnail<i class="fal fa-user" style="top: 50px;"></i></label>
                                                <input type="text" name="gambar" placeholder="Link URL" value="<?php echo $informasi->foto; ?>">
                                            </div>
                                            <div class="col-sm-12">
                                                <label style="padding: 10px;"> Isi</label>
                                                <br>
                                                <textarea name="isi" placeholder="Tindak Lanjut" style="margin-bottom:20px;" style="height: 200px">
