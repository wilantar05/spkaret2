...
<head>
    <!--=============== basic  ===============-->
    <meta charset="UTF-8">
    <title>Beranda Admin Divisi</title>
                                        ...
                                        <tbody>
                                            ...
                                            ?>
                                                <tr>
                                                    ...
                                                    <td><a href="<?php echo site_url(); ?>tindak_lanjut?id=<?php echo $pengaduan->id_pengaduan; ?>"><button type="button" class="btn btn-primary"><?php echo $admin->id_bidang ?></button></a></td>
                                                </tr>
                                            <?php } ?>
                                        </tbody>
                                    </table>
