                ...
                <div class="list-single-main-item fl-wrap block_box">
                  ...
                  <div class="list-single-main-item_content fl-wrap">
                    <div class="reviews-comments-wrap" style="width: 100%;">
                      ...
                      <div class="reviews-comments-item only-comments">
                        <div class="review-comments-avatar">
                          <img src="<?php echo site_url(); ?>assets/umum/images/avatar/icon.png" alt="">
                        </div>
                        <div class="reviews-comments-item-text fl-wrap">
                          <div class="reviews-comments-header fl-wrap">
                            <h4><a href="#">Kantor Desa Telagatawang</a></h4>
                          </div>
                          <p>
                            <?php if ($data_pengaduan->status == 0) {
                            ?>
                              Terimakasih, Laporan Anda Kami Terima dan Sedang Dalam Proses Penyelesaian
                            <?php
                            } else {
                            ?>
