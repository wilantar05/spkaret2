...
<head>
    <!--=============== basic  ===============-->
    <meta charset="UTF-8">
    <title>Beranda Kepala Desa</title>
                                        ...
                                        <tbody>
                                            ...
                                            ?>
                                                <tr>
                                                    ...
                                                    <td><a href="<?php echo site_url(); ?>kades_detail?id=<?php echo $admin->id; ?>"><button type="button" class="btn btn-warning">Edit</button></a><a href="<?php echo site_url(); ?>kades_hapus?id=<?php echo $admin->id; ?>"><button type="button" class="btn btn-danger">Hapus</button></a></td>
                                                </tr>
                                            <?php } ?>
                                        </tbody>
                                    </table>
