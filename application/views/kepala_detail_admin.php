                    ...
                    <div class="container">
                        ...
                        <div class="col-md-3">
                            ...
                            <div class="fixed-bar fl-wrap" id="dash_menu">
                                <?php echo $this->load->view('share/menu_kepala', '', TRUE); ?>
                            </div>
                        ...
                        <div class="col-md-9">
                            ...
                            <div class="list-single-main-item fl-wrap block_box " style="padding: 20px;">
                                <div class="custom-form" style="padding: 20px;">
                                    <form action="<?php echo site_url(); ?>kades_update?id=<?php echo $admin->id; ?>" method="post" enctype="multipart/form-data">

                                        <div class="row">
                                            <div class="col-sm-6">
                                                <label style="padding: 10px;">Username<i class="fal fa-user" style="top: 50px;"></i></label>
                                                <input required type="text" name="username" value="<?php echo $admin->username; ?>">
                                            </div>
                                            <div class="col-sm-6">
                                                <label style="padding: 10px;">Password<i class="fal fa-user" style="top: 50px;"></i></label>
                                                <input required type="password" name="password" placeholder="Masukkan Password" value="<?php echo $admin->password; ?>">
                                            </div>
                                            <div class="col-sm-6">
                                                <label style="padding: 10px;">Nama Lengkap<i class="fal fa-user" style="top: 50px;"></i></label>
                                                <input required type="text" name="nama_lengkap" value="<?php echo $admin->nama; ?>">
                                            </div>
                                            ...
                                            <div class="col-sm-6">
                                                ...
                                                <div class="listsearch-input-item">
                                                    <select data-placeholder="City" name="bidang" class="chosen-select no-search-select" required>
                                                        <option value="<?php echo $admin->id_bidang; ?>"><?php echo $admin->nama_bidang; ?></option>
                                                        <?php
                                                        foreach ($bidang as $bidang) {
                                                            if ($admin->id_bidang != $bidang->id_bidang) {
                                                        ?>
