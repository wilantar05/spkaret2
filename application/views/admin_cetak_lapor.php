        ...
        <div class="container  ">
          <div class="row">
            <div class="col-md-6 col-lg-6">
              <div>
                <img src="<?php echo site_url(); ?>assets/umum/images/Kop.png" width="100%">
                ...
                <table width="100%">
                  ...
                  <tr>
                    ...
                    <td style="vertical-align:top">:</td>
                    <td style="vertical-align:top"><?php echo $detail->tanggal_pengaduan; ?></td>
                  </tr>
                  <tr>
                    <td>&nbsp;</td>
                    <td style="vertical-align:top">b.</td>
                ...
                <table>
                  <tr>
                    ...
                    <td>&nbsp;</td>
                    <td>&nbsp;</td><br>
                    <img src="<?= base_url('assets/gambar_pengaduan/'.$detail->gambar)?>" width="250px" height="200px">
                  </tr>
                ...
                <table width="100%">
                  <tr>
                    ...
                    $tanggal = $pecahkan[2] . ' ' . $bulan[(int)$pecahkan[1]] . ' ' . $pecahkan[0];
                    ?>
                    <td>Sidemen, <?php echo $tanggal; ?></td>
                    <td>&nbsp;</td>
                  </tr>
                  <tr>
              ...
              <br>
                <table height="150px" width="100%" border="1" style="border: 1px solid black" align="center">
                  ...
                  <tr>
                    ...
                    <td style="vertical-align:top;">Kantor Desa Telagatawang <br> Seksi
                      <?php
                ...
                <table>
                  ...
                  <tr>
                    ...
                    <td style="vertical-align:top;">
                      <div align="justify">Informasi tindak lanjut penanganan disampaikan kepada pengadu paling lama 5 hari sejak diterimanya pengaduan oleh unit teknis.</div>
                    </td>
                  </tr>
                </table>
                <br>
